...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("MS Suporte".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["suporte.msgestaopublica.app.br"];
pub const RS_PUB_KEY: &str = "D73+7HTEOIvcBLoZuXzpcQXJavssNP1ALbMb2AWqgR4=";
